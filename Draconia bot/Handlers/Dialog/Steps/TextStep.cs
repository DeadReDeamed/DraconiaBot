...
namespace Draconia_bot.Handlers.Dialog.Steps
{
        ...
        public override async Task<bool> ProcessStep(DiscordClient client, DiscordChannel channel, DiscordUser user)
        {
            ...
            while (true)
            {
                ...
                if(_minLength.HasValue)
                {
                    ...
                    {
                        await TryAgain(channel, $"Your input is {_minLength - messageResult.Result.Content.Length} character to short");
                        continue;
                    }
                }
                ...
                if (_maxLength.HasValue)
                {
                    ...
                    {
                        await TryAgain(channel, $"Your input is {messageResult.Result.Content.Length - _maxLength} character to long");
                        continue;
                    }
                }
